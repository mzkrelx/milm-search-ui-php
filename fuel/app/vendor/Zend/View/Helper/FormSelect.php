        ...
        $options = null, $listsep = "<br />\n")
    {
        ...
        foreach ((array) $options as $opt_value => $opt_label) {
            if (is_array($opt_label)) {
                ...
                // edited by Mizuki Yamanaka
                // --------------------------
                $optValueAndLabel = str_getcsv($opt_value);
                if (count($optValueAndLabel) == 2) {
                    $opt_id = ' id="' . $this->view->escape($id) . '-optgroup-'
                        . $this->view->escape($optValueAndLabel[0]) . '"';
                    $list[] = '<optgroup'
                        . $opt_disable
                        . $opt_id
                        . ' label="' . $this->view->escape($optValueAndLabel[1]) .'">';
