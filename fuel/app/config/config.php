...
return array(
	 ...
	 *
	 * mod_rewriteなどを使うと、URLに含まれるindex.phpを削除することが可能です。
	 * http://example.jp/index.php/bbs/ を
	 * http://example.jp/bbs/ でアクセス可能に設定できます。
	 */
//  	'index_file'  => 'index.php',
	 ...
	 * languageは、具体的にはFuelPHPの言語ファイルのあるフォルダ名を
	 * 指定することになります。
	 * 日本語の言語ファイルはありませんが、自分で作成することができますので
	 * 「ja」に変更しておきます。
	 * 言語ファイルを用意しなくてもフォールバック設定で英語の言語ファイルが
	 * 使われるため動作に問題は生じません。
	 */
